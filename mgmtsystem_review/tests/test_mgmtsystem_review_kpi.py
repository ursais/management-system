...
class TestMgmtsystemReviewKpi(BaseCommon):
    ...
    def setUpClass(cls):
        ...
        threshold_range = cls.env["kpi.threshold.range"].create(
            {"name": "OK", "min_value": 0, "max_value": 100, "color": "#00FF00"}
        )
    ...
    def test_create_autopopulates_kpi_history(self):
        """Creating a review auto-populates kpi_history_ids with latest history per KPI."""
    ...
    def test_create_no_kpi_history(self):
        ...
        self.assertNotIn(
            kpi3, review.kpi_history_ids.mapped("kpi_id"),
